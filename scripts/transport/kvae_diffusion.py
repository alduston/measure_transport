...
def cond_kernel_transport(X_mu, Y_mu, Y_eta, Y_mean, Y_var, X_mu_test, Y_eta_test, Y_mu_test, X_mu_val,
                          ...
                          reg_lambda=1e-6, grad_cutoff = .0001, n_iter = 200, target_eps = 1, var_eps = .1):
...
def comp_cond_kernel_transport(X_mu, Y_mu, Y_eta, Y_eta_test, X_mu_test, Y_mu_test, X_mu_val, params,
                               final_eps=1e-2, n_transports=50, reg_lambda=1e-6, n_iter = 200,var_eps = .1):
...
def run():
    ...
    two_d_exp(ref_gen=sample_normal, target_gen=sample_elden_ring, N=7000, exp_name='exp', n_transports=80,
