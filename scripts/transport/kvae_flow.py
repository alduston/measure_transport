...
def run():
    ...
    batch_size = 500
    n_transports = 5
    two_d_exp(ref_gen, sample_spirals, N=N, plt_range=[[-2.5, 2.5], [-1.1, 1.1]], process_funcs=[],
              batch_size=batch_size, skip_idx=1, slice_vals=[0], slice_range=[-3, 3], exp_name='exp',
              n_transports=n_transports, vmax=.25, reg_lambda=1e-5)
