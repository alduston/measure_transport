...
def run():
    test_panel(N=5000, n_transports=100, k=1, approx_path=True, test_name='lv_test_med', test_keys=['lv'])
    test_panel(N=5000, n_transports=100, k=1, approx_path=False, test_name='lv_test_med2', test_keys=['lv'])
